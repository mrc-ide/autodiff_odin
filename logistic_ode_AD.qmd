...
## Thoughts on the general case & Jacobian-vector product

- General case is $$\frac{da(t)}{dt}=-a(t)^{\intercal} \frac{\partial f(z(t),t,\theta)}{\partial z}$$
- RHS is the Jacobian-Vector product (jvp)
